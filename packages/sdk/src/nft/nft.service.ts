...
import { LiqERC1155, LiqERC1155__factory, LiqERC721, LiqERC721__factory } from '../../typechain-types';
...
export abstract class NftService {
  ...
  public static async getNfts(owner: string, chainID: number): Promise<Nft[] | null> {
